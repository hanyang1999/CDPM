...
def train(config, workdir):
  ...
  if config.training.sde.lower() == 'vpsde':
    ...
    sampling_eps = 1e-5
  elif config.training.sde.lower() == 'csubvpsde':
    sde = sde_lib.CsubVPSDE(cbeta_min=config.model.cbeta_min, cbeta_max=config.model.cbeta_max, N=config.model.num_scales)
    sampling_eps = 1e-5
  else:
